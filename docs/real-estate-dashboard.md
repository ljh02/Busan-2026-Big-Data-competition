...
BalueWave의 지도 기능을 생활권 추천 지도에서 주거 의사결정 지도까지 확장한다. 사용자는 지도에서 아파트 단지를 클릭해 가격, 생활권, 이동, 전세 위험 신호를 한 화면에서 확인하고, 여러 단지를 비교하거나 AI Agent에 질문할 수 있다.

## 레퍼런스 조사 요약

| 서비스 | 참고한 기능 구조 | BalueWave 적용 방식 |
| --- | --- | --- |
...
| Redfin | 매매·렌트·내 집 가치, affordability, agent 연결 | BalueWave는 중개 연결 대신 통근·생활 SOC·위험 신호 기반 AI 설명으로 차별화 |
